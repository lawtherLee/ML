...
print(
    f"单个决策树对象的准确率: {accuracy_score(y_test, y_predict)}"
)  # 0.8044692737430168
print("-" * 23)
...
# 4.4 模型评估.
print(
    f"梯度提升树对象的准确率: {accuracy_score(y_test, y_predict)}"
)  # 0.8100558659217877
...
# 4.1 定义模型可选参数
param_dict = {
    "n_estimators": [60, 80, 100, 120, 140, 160, 170],  # 弱学习器的数量
    "learning_rate": [0.3, 0.5, 0.7],  # 学习率
    "max_depth": [3, 5, 10],  # 树最大深度
}
# 4.2 创建 梯度提升树 模型对象.
